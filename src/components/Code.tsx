...
const Code = ({ code, language, show, animated, animationDelay, }: CodeProps) => {
    // Component Theme
    ...
    useEffect(() => {
        if(show && animated){
            ...
            setTimeout(() => {
                ...
                // Code Cleanup: Prevent Memory Leak on Component Unload
                return () => clearInterval(intervalId)
            }, animationDelay || 150)
        }
    }, [code, show, animated, animationDelay])

    // Number of Lines Calculation using Regex
